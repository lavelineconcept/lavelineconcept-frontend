...
import iyzicoLogo from "../../assets/logo_band_white@2x.png"
    ...
    <footer className={css.footerContainer}>
      <div className={css.footerTop}>
        ...
        <div className={css.footerNav}>
          <Link to="/about" className={css.footerLink}>Hakkımızda</Link>
          <Link to="/contact" className={css.footerLink}>İletişim</Link>
          <Link to="/delivery" className={css.footerLink}>Teslimat ve İadeler</Link>
          <Link to="/privacy-policy" className={css.footerLink}>Gizlilik Politikası</Link>
          <Link to="/distance-sales-agreement" className={css.footerLink}>Mesafeli Satış Sözleşmesi</Link>
        </div>
